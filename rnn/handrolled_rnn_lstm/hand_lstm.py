...
#   imput / x_t
  ...
  def __init__(self, input_dim, hidden_dim):
    super().__init__()
    self.Wf_x = nn.Parameter(torch.randn(hidden_dim, input_dim))
    self.Wi_x = nn.Parameter(torch.randn(hidden_dim, input_dim))
    self.Wg_x = nn.Parameter(torch.randn(hidden_dim, input_dim))
    self.Wo_x = nn.Parameter(torch.randn(hidden_dim, input_dim))
    self.Wf_h = nn.Parameter(torch.randn(hidden_dim, hidden_dim))
    self.Wi_h = nn.Parameter(torch.randn(hidden_dim, hidden_dim))
    self.Wg_h = nn.Parameter(torch.randn(hidden_dim, hidden_dim))
    self.Wo_h = nn.Parameter(torch.randn(hidden_dim, hidden_dim))
